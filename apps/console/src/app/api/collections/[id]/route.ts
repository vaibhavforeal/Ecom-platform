...
import { updateCollection } from "@platform/core/catalog/server";
...
/** Replace a collection. As with products, the body is the whole of it. */
export async function PUT(
  ...
  return handleCatalogWrite(req, taxonomyPayloadSchema, (ctx, payload) =>
    updateCollection(ctx, id, toTaxonomyWriteInput(payload)),
  );
}
